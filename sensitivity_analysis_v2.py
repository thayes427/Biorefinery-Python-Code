...
import GUI_multivariate_v2 as GUI
...
def mp_worker(aspenlock, excellock, input, output):
    for func, args in iter(input.get, 'STOP'):
        result = func(aspenlock, excellock, *args)
        output.put(result)


def mp_aspenrun(aspenlock, excellock, aspenfilename, excelfilename, aspen_call, aspen_var_name, value, fortran_index):
    '''
    ...
    print('here2')
    aspenlock.acquire()
    aspen,obj = open_aspenCOMS(aspenfilename)
    aspenlock.release()
